...
def test_production_app_id_forces_production_hosts():
    settings = Settings(ebay_env="sandbox", ebay_client_id="example-ebaybot-PRD-123456789")
...
def test_sandbox_app_id_forces_sandbox_hosts():
    settings = Settings(ebay_env="production", ebay_client_id="example-ebaybot-SBX-123456789")
