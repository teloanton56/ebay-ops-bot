...
cd /d "%~dp0"
title eBay Ops Bot v0.14.1

set "PORT=8765"
set "URL=http://127.0.0.1:%PORT%"

echo ==========================================================
echo   eBay Ops Bot v0.14.1
echo ==========================================================
echo.
...
start "" /b powershell -NoProfile -WindowStyle Hidden -Command "$u='%URL%/health'; for($i=0;$i -lt 60;$i++){try{$r=Invoke-RestMethod -Uri $u -TimeoutSec 1;if($r.version -eq '0.14.1'){Start-Process '%URL%';exit}}catch{};Start-Sleep -Milliseconds 500}"
